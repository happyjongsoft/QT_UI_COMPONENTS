...
QtJoystickPad::QtJoystickPad(QWidget *parent, Qt::WindowFlags f) : QWidget(parent, f),
    m_x(0), m_y(0),
...
/**
 * @brief QtJoystickPad::x
 * @return
 */
float QtJoystickPad::x() const
{
    return m_x;
}

/**
 * @brief QtJoystickPad::y
 * @return
 */
float QtJoystickPad::y() const
{
    return m_y;
}

/**
 * @brief QtJoystickPad::setX
 * @param value of x axis from -1 to 1
 */
void QtJoystickPad::setX(float value)
{
...
/**
 * @brief QtJoystickPad::setY
 * @param value of y axis from -1 to 1
 */
void QtJoystickPad::setY(float value)
{
...
void QtJoystickPad::removeXAnimation()
{
...
void QtJoystickPad::addXAnimation()
{
...
void QtJoystickPad::removeYAnimation()
{
...
void QtJoystickPad::addYAnimation()
{
    if (m_yAnimation->parent() == m_returnAnimation) return;
...
void QtJoystickPad::setAlignment(Qt::Alignment f)
{
    m_alignment = f;
}

/**
 * @brief QtJoystickPad::resizeEvent
 * @param event
 *
 * calculates a square bounding rect for the background and the knob
 */
void QtJoystickPad::resizeEvent(QResizeEvent *event)
{
    Q_UNUSED(event)
...
/**
 * @brief QtJoystickPad::paintEvent
 * @param event
 */
void QtJoystickPad::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
...
/**
 * @brief QtJoystickPad::mousePressEvent
 * @param event
 */
void QtJoystickPad::mousePressEvent(QMouseEvent *event)
{
...
/**
 * @brief QtJoystickPad::mouseReleaseEvent
 * @param event
 */
void QtJoystickPad::mouseReleaseEvent(QMouseEvent *event)
{
    Q_UNUSED(event)
...
/**
 * @brief QtJoystickPad::mouseMoveEvent
 * @param event
 */
void QtJoystickPad::mouseMoveEvent(QMouseEvent *event)
{
